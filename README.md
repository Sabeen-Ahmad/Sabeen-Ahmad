...
- 🔭 Currently building **Nexora** (Flutter + Laravel + Gemini API + Firebase FCM), an Unstop-style accountability platform with gamification, cohorts, and 100-days-of-code challenges
- 💼 Completed a Flutter Developer internship at **TheCodersHub**, working on **ReadBuddy** — a book donation/borrowing app
- 🌱 Exploring AI/ML through my MS applications (GIKI, NUST SEECS)
- 🛠️ Stack: Flutter, Dart, BLoC/Cubit, Clean Architecture, Laravel, MySQL, Firebase, GoRouter, Dio
- 💞️ Open to collaborating on Flutter/mobile projects, and to internship/entry-level opportunities
- 📫 Reach me at **asma08071999@gmail.com**
- 😄 Pronouns: she/her
